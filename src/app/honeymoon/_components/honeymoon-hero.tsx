...
import { HoneymoonHero as HoneymoonHeroType } from '@/types/honeymoon';

interface HoneymoonHeroProps {
  hero: HoneymoonHeroType;
}

export function HoneymoonHero({ hero }: HoneymoonHeroProps) {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Fallback pattern if mobileImage is absent but on mobile */}
      {!hero.mobileImage && (
        <div className="absolute inset-0 md:hidden">
          <Image
             src={hero.image.url}
