...
export function WeddingGallery({ images, isWeddingPage = false }: WeddingGalleryProps) {
        ...
        <Container>
          ...
          {isWeddingPage && (
            <div className="text-center mb-12 sm:mb-16">
              ...
              <a
                href="https://youtu.be/Wb2TaDYcZr4"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white rounded-lg transition-colors duration-200 text-sm sm:text-base font-medium shadow-md hover:shadow-lg"
              >
                <svg
